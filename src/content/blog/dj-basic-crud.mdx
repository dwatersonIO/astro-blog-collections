...
category:
tags: [django]
description:  C[reate] R[ead] U[pdate] D[elete] with Function-based Views in Django
---
Django has great class-based views for Create/Read/Update/Delete operations. But when you are learning function based views are the way to go because they give you a good understanding of what is happening without a lot of abstrations See how with this basic notes app. 
