...
date: 2024-09-23
tags: [django, python]
description: Many-to-Many relationship models, without n+1 problem
---
Searches involving a many-to-many relationship can be tricky. Note how 'distinct' is essential.We will use a scenario based on a Notes model. Each Note may have many Tags. Note the search view below:
